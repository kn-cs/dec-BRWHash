...
def getKeyRandom(k):
	...
	key = []
	f = open("decbrwhash1271_t2_speed_record_test_cases_keyfile.txt", "w")
	for i in range(k): 
...
def genSpeedTestCases():
	...
	t = 2;
	f = open("decbrwhash1271_t2_speed_record_test_cases.txt", "w")
	start = 120
	stop = 24000+120
	step = 120
...
def genSpeedTestCasesDirectCmp():
	...
	t = 2;
	f = open("decbrwhash1271_t2_speed_record_test_cases_direct_cmp.txt", "w")
