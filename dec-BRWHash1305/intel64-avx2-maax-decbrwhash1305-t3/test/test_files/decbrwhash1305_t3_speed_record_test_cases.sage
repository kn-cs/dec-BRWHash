...
def getKeyRandom(k):
	...
	key = []
	f = open("decbrwhash1305_t3_speed_record_test_cases_keyfile.txt", "w")
	for i in range(k): 
...
def genSpeedTestCases():
	...
	t = 3;
	f = open("decbrwhash1305_t3_speed_record_test_cases.txt", "w")
	start = 128
	stop = 25600+128
	step = 128
...
def genSpeedTestCasesDirectCmp():
	...
	t = 3;
	f = open("decbrwhash1305_t3_speed_record_test_cases_direct_cmp.txt", "w")
