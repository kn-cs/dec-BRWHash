...
#define brw4x_mul_tau(x,y)			\
	...
	vpsrlq    $40,%ymm3,%ymm10;		\
						\
	vmovdqa   160*y+0*32(%rdi),%ymm11;	\
	vmovdqa   160*y+1*32(%rdi),%ymm12;	\
	vmovdqa   160*y+2*32(%rdi),%ymm13;	\
	vmovdqa   160*y+3*32(%rdi),%ymm14;	\
	vmovdqa   160*y+4*32(%rdi),%ymm15;	\
						\
	vpmuludq  %ymm11,%ymm6,%ymm0;		\
						\
	vpmuludq  %ymm11,%ymm7,%ymm1;		\
...
#define brw4x_store_temp(x)			\
						\
	vmovdqa   %ymm0,x+0*32(%rsp);		\
	vmovdqa   %ymm1,x+1*32(%rsp);		\
	vmovdqa   %ymm2,x+2*32(%rsp);		\
	vmovdqa   %ymm3,x+3*32(%rsp);		\
	vmovdqa   %ymm4,x+4*32(%rsp);		\

#define brw4x_add_temp(x)			\
						\
	vpaddq    x+0*32(%rsp),%ymm0,%ymm0;	\
	vpaddq    x+1*32(%rsp),%ymm1,%ymm1;	\
	vpaddq    x+2*32(%rsp),%ymm2,%ymm2;	\
	vpaddq    x+3*32(%rsp),%ymm3,%ymm3;	\
	vpaddq    x+4*32(%rsp),%ymm4,%ymm4;	\
